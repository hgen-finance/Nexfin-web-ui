...
export default {
  ...
  computed: {
    ...
    getCheckedColor () {
      return this.modelValue ? `br-${this.modelData.colorBorderChecked} ${this.modelData.colorBackgroundChecked}`: `br-${this.modelData.colorBorder} ${this.modelData.colorBackground}`
    }
  },
  data () {
    return {
