<template>
  <div class="container pt-20-M pt-20-S pt-40-XS mb-10-S mb-20-XS">
    <div
      class="w-100 tt-u fs-14-S fs-30-XS fw-600 f-white-200 ta-c"
      data-aos="zoom-in"
    >
      DeFi FEATURES
    </div>
    <div class="w-100 fd-r jc-c pt-0-S pt-30-XS">
      <div class="w-80-S w-100-XS fd-r ai-t jc-c fw-w">
        <div
          class="w-33-S w-60-XS fd-c jc-c ai-c p-10-S p-15-XS"
        ...
        >
          <div
            class="
              ...
              jc-c
              shadow-purple-100
              rad-fix-4-S rad-fix-20-XS
              py-6-M py-4-S py-15-XS
            "
          >
            <img
              :src="require('@/assets/svg/' + item.img)"
              class="h-fix-40-M h-fix-30-S h-fix-100-XS"
            />
          </div>
          <div
            class="
          ...
          <div
            class="w-100 pt-2-S pt-10-XS fs-6-S fs-20-XS fw-400 f-gray-500 ta-c"
          >
            {{ item.text }}
          </div>
        </div>
  ...
  data() {
    return {
      ...
      hydrogenItems: [
        ...
        {
          name: "Farms",
          text: "The farming will give you additional benefit.",
          img: "roadMap2.png",
          items: [
            {
              img: "checkOn.svg",
        ...
        },
        {
          ...
          text: "Hydrogen cars registered on the platform will be connected to the HGEN network of data. Including hydrogen charging stations, hydrogen consumption usage, and the ability to pay using HGEN/GENS Tokens.",
          img: "roadMap3.png",
          items: [
            {
              img: "checkOn.svg",
              name: "Ex Hydrogen vehicle data aggregator",
            },
            {
              img: "checkOn.svg",
