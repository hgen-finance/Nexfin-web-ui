...
const SOLANA_WALLET = path.resolve(__dirname, 'src/components/solana-wallet')
...
//           console.log('price after get value: ', price);
//           return data.solana.usd
//         });
//       }
//     )
//     // .then(response => response.json())
//     // .then(data => (price = data.solana.usd));
