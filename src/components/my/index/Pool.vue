<template>
  <div class="w-90-S w-100-XS h-100min fd-c l-0-S">
    <div class="w-100 fs-8-S fs-25-XS fw-600 f-white-200 pb-5-S pb-10-XS ta-c-XS">
      Pool
    </div>
    <div class="w-100 fd-r ai-c ">
      <div class="w-70-S w-50-XS">
        ...
        <div class="w-100 fs-5-S fs-25-XS f-white-200">
          <span class="f-mcolor-100 fs-8-S fs-25-XS fw-900">{{getPercent}}</span>
    ...
    <div class="w-100 fd-r ai-c py-2-S py-10-XS my-2-S my-10-XS">
      ...
      <div class="w-45 fsh-0 fs-5-S fs-20-XS f-white-200 fw-600 ta-r">
        <span class="f-mcolor-100 pr-1-S pr-3-XS">{{ getDepositeTotal.toLocaleString() }}</span> GENS
      </div>
    </div>
    <div class="w-100 fs-6-S fs-20-XS f-gray-600 pb-2-S pb-5-XS fw-600">
          Your current earnings
    </div>
    <div class="w-100 fd-r ai-c py-2-S py-5-XS mt-0-S">
    ...
    <div class="w-45-S w-100-XS  fsh-0 mt-3-S mt-10-XS fd-r jc-r ">
        <AmButton :height="false" color="mcolor-200" bColor="mcolor-100" opacityEffect full @click="claimFunc" v-if="true">
          claim
        </AmButton>
    ...
    <div class="w-100 pt-8-S pt-20-XS pb-4-S pb-15-XS">
      <AmButton color="mcolor-100" bColor="mcolor-100" opacityEffect full to="/my/pool">
        GO
      </AmButton>
    </div>
