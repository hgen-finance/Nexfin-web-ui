<template>
  <div class="container w-100 fd-c jc-c pt-10 pb-10 m-0-auto">
    <div class="w-70-L w-70-M w-100-S gradient-200 rad-fix-8 p-10-M p-10-S p-10-XS m-0-auto br-mcolor-400 br-1 brs-s">
      <Notification />
      <div class="w-100 pt-10">
        ...
        <div class="w-100 fd-r ai-s br-t-4 brts-d br-mcolor-400" v-for="(data, d) in depositList" :key="d">
          ...
          <div class="d-i fs-5 ta-c px-1 py-4 br-r-4 brrs-s br-mcolor-400 fd-r ai-c jc-c w-100 f-mcolor-300" :title="data.deposit">
            <div class="w-100 h-100 fd-r ai-c jc-c ta-c fw-400">
...
export default {
  ...
  methods: {
    ...
    find () {
      this.page = 1
      this.$accessor.admin.getDepositList({page: this.page, clear: true, search: this.search})
    },
    nextPage() {
      this.page += 1
