...
// for hgen-sol pool
export const TOKEN_ACC_HGEN_HS = new PublicKey("G7BXM8B9qzW1reYsD6myAxCEm176WNG7UgiSNauHaQZ8");
export const TOKEN_ACC_SOL_HS = new PublicKey("9LGdVahCQQ8MHK1EQsKS965tNi69iH5qyoYASFN2r6kU");

export const TOKEN_SWAP_HGEN_SOL_ACCOUNT = new PublicKey("FsQ4J8i2kziaihjCjMszeDCCmi9EzUFiFMXwkv5wLmv5");

export const LP_TOKENS_HS = new PublicKey("JCGWBPdM5q172VFfZV43uQr6bmcJM3pASmCqMNb1MEVn");
export const LP_TOOKS_HS_POOL_ACC = new PublicKey("gMa8KUkxASTJqKQCEGGWzrJMCXJcL83tdfa7UpP16fq");
export const LP_POOL_OWNER_HS = new PublicKey("424v2hHJtDA879UfMikVWr7VTvJsFqE9XaZkkbe6Uv2J");

export const POOL_AUTHORITY_HS = new PublicKey("qSt4fR5GTs2u3w3xCnTErWxXdrUDNu7VPbCs7TGxKzT");
